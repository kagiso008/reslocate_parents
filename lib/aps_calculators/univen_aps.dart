...
class CalculateUNIVENAPSPage extends StatefulWidget {
  const CalculateUNIVENAPSPage({super.key});

  @override
  _CalculateUNIVENAPSPageState createState() => _CalculateUNIVENAPSPageState();
}

class _CalculateUNIVENAPSPageState extends State<CalculateUNIVENAPSPage> {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => GetAvailableCoures2Page(
                                    aps: aps ?? 0,
                                    universityName: 'University of Venda')),
                          );
                        },
