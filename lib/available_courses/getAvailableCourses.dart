...
class GetAvailableCouresPage extends StatefulWidget {
  ...
  @override
  _GetAvailableCouresPageState createState() => _GetAvailableCouresPageState();
}

class _GetAvailableCouresPageState extends State<GetAvailableCouresPage> {
  ...
  Future<void> _fetchAvailableCourses(int aps, String universityName) async {
    try {
