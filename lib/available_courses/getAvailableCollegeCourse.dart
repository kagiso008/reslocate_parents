...
class GetAvailableCollegeCouresPage extends StatefulWidget {
  ...
  const GetAvailableCollegeCouresPage({
    super.key,
    required this.aps,
  ...
  @override
  _GetAvailableCollegeCouresPageState createState() =>
      _GetAvailableCollegeCouresPageState();
}

class _GetAvailableCollegeCouresPageState
    extends State<GetAvailableCollegeCouresPage> {
  ...
  void initState() {
    super.initState();
    _fetchAvailableCourses(widget.aps, widget.collegeName); // Example
  ...
  Future<void> _fetchAvailableCourses(int aps, String collegeName) async {
    try {
