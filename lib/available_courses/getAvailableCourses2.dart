...
class GetAvailableCoures2Page extends StatefulWidget {
  ...
  @override
  _GetAvailableCoures2PageState createState() =>
      _GetAvailableCoures2PageState();
}

class _GetAvailableCoures2PageState extends State<GetAvailableCoures2Page> {
  ...
  void initState() {
    super.initState();
    _fetchAvailableCourses(widget.aps, widget.universityName); // Example
  ...
  Future<void> _fetchAvailableCourses(double aps, String universityName) async {
    try {
...
class CoursePage extends StatelessWidget {
  ...
  final double userAps; // Add user's APS as a parameter
