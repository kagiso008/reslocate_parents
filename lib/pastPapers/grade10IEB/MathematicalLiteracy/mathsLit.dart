...
class MathematicalLiteracyGrade10IEBPage extends StatefulWidget {
  const MathematicalLiteracyGrade10IEBPage({super.key});

  @override
  _MathematicalLiteracyGrade10IEBPageState createState() =>
      _MathematicalLiteracyGrade10IEBPageState();
}

class _MathematicalLiteracyGrade10IEBPageState
    extends State<MathematicalLiteracyGrade10IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_10/IEB/Mathematical Literacy');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_10/IEB/Mathematical Literacy/$fileName';
