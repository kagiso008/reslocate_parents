...
class MathsGrade12IEBPage extends StatefulWidget {
  const MathsGrade12IEBPage({super.key});

  @override
  _MathsGrade12IEBPageState createState() => _MathsGrade12IEBPageState();
}

class _MathsGrade12IEBPageState extends State<MathsGrade12IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/IEB/Mathematics');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/IEB/Mathematics/$fileName';
