...
class MathematicalLiteracyGrade12IEBPage extends StatefulWidget {
  const MathematicalLiteracyGrade12IEBPage({super.key});

  @override
  _MathematicalLiteracyGrade12IEBPageState createState() =>
      _MathematicalLiteracyGrade12IEBPageState();
}

class _MathematicalLiteracyGrade12IEBPageState
    extends State<MathematicalLiteracyGrade12IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/IEB/MathematicalLiteracy');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/IEB/MathematicalLiteracy/$fileName';
