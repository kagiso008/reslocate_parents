...
class AgriculturalScienceGrade12IEBPage extends StatefulWidget {
  const AgriculturalScienceGrade12IEBPage({super.key});

  @override
  _AgriculturalScienceGrade12IEBPageState createState() =>
      _AgriculturalScienceGrade12IEBPageState();
}

class _AgriculturalScienceGrade12IEBPageState
    extends State<AgriculturalScienceGrade12IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/IEB/AgriculturalSciences');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/IEB/AgriculturalSciences/$fileName';
