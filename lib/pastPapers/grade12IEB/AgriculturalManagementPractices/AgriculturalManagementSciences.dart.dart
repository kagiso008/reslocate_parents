...
class AgriculturalManagementPracticesIEB extends StatefulWidget {
  const AgriculturalManagementPracticesIEB({super.key});

  @override
  _AgriculturalManagementPracticesIEBState createState() =>
      _AgriculturalManagementPracticesIEBState();
}

class _AgriculturalManagementPracticesIEBState
    extends State<AgriculturalManagementPracticesIEB> {
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path =
          'grade_12/IEB/AgriculturalManagementPractices/$fileName';
