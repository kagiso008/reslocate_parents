...
class LifeSciencesGrade12IEBPage extends StatefulWidget {
  const LifeSciencesGrade12IEBPage({super.key});

  @override
  _LifeSciencesGrade12IEBPageState createState() =>
      _LifeSciencesGrade12IEBPageState();
}

class _LifeSciencesGrade12IEBPageState
    extends State<LifeSciencesGrade12IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/IEB/LifeSciences');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/IEB/LifeSciences/$fileName';
