...
class GujaratiFALGrade12IEBPage extends StatefulWidget {
  const GujaratiFALGrade12IEBPage({super.key});

  @override
  _GujaratiFALGrade12IEBPageState createState() =>
      _GujaratiFALGrade12IEBPageState();
}

class _GujaratiFALGrade12IEBPageState extends State<GujaratiFALGrade12IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/IEB/GujaratiFAL');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/IEB/GujaratiFAL/$fileName';
