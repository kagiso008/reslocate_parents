...
class AfrikaansFALGrade12IEBPage extends StatefulWidget {
  const AfrikaansFALGrade12IEBPage({super.key});

  @override
  _AfrikaansFALGrade12IEBPageState createState() =>
      _AfrikaansFALGrade12IEBPageState();
}

class _AfrikaansFALGrade12IEBPageState
    extends State<AfrikaansFALGrade12IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/IEB/AfrikaansFAL');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/IEB/AfrikaansFAL/$fileName';
