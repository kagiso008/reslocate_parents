...
class VisualCultureStudiesGrade12IEBPage extends StatefulWidget {
  const VisualCultureStudiesGrade12IEBPage({super.key});

  @override
  _VisualCultureStudiesGrade12IEBPageState createState() =>
      _VisualCultureStudiesGrade12IEBPageState();
}

class _VisualCultureStudiesGrade12IEBPageState
    extends State<VisualCultureStudiesGrade12IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/IEB/VisualCultureStudies');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/IEB/VisualCultureStudies/$fileName';
