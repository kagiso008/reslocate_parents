...
class LatinSALGrade12IEBPage extends StatefulWidget {
  const LatinSALGrade12IEBPage({super.key});

  @override
  _LatinSALGrade12IEBPageState createState() => _LatinSALGrade12IEBPageState();
}

class _LatinSALGrade12IEBPageState extends State<LatinSALGrade12IEBPage> {
