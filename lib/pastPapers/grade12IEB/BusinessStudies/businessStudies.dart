...
class BusinessStudiesGrade12IEBPage extends StatefulWidget {
  const BusinessStudiesGrade12IEBPage({super.key});

  @override
  _BusinessStudiesGrade12IEBPageState createState() =>
      _BusinessStudiesGrade12IEBPageState();
}

class _BusinessStudiesGrade12IEBPageState
    extends State<BusinessStudiesGrade12IEBPage> {
