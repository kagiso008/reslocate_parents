...
class GeographyGrade11Page extends StatefulWidget {
  ...
  @override
  _GeographyGrade11PageState createState() => _GeographyGrade11PageState();
}
...
class _GeographyGrade11PageState extends State<GeographyGrade11Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects =
          await supabase.storage.from('pdfs').list(path: 'grade_11/Geography');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_11/Geography/$fileName';
