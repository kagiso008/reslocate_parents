...
class AgriculturalScienceGrade11Page extends StatefulWidget {
  const AgriculturalScienceGrade11Page({super.key});

  @override
  _AgriculturalScienceGrade11PageState createState() =>
      _AgriculturalScienceGrade11PageState();
}

class _AgriculturalScienceGrade11PageState
    extends State<AgriculturalScienceGrade11Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_11/AgriculturalSciences');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_11/AgriculturalSciences/$fileName';
