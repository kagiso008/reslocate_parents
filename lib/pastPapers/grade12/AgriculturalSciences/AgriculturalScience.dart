...
class AgriculturalScienceGrade12Page extends StatefulWidget {
  const AgriculturalScienceGrade12Page({super.key});

  @override
  _AgriculturalScienceGrade12PageState createState() =>
      _AgriculturalScienceGrade12PageState();
}

class _AgriculturalScienceGrade12PageState
    extends State<AgriculturalScienceGrade12Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/AgriculturalScience');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/AgriculturalScience/$fileName';
