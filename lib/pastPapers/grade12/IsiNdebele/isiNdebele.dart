...
class IsiNdebeleGrade12Page extends StatefulWidget {
  const IsiNdebeleGrade12Page({super.key});

  @override
  _IsiNdebeleGrade12PageState createState() => _IsiNdebeleGrade12PageState();
}

class _IsiNdebeleGrade12PageState extends State<IsiNdebeleGrade12Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects =
          await supabase.storage.from('pdfs').list(path: 'grade_12/IsiNdebele');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/IsiNdebele/$fileName';
