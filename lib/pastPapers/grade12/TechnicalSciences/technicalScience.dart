...
class TechnicalScienceGrade12Page extends StatefulWidget {
  const TechnicalScienceGrade12Page({super.key});

  @override
  _TechnicalScienceGrade12PageState createState() =>
      _TechnicalScienceGrade12PageState();
}

class _TechnicalScienceGrade12PageState
    extends State<TechnicalScienceGrade12Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/TechnicalSciences');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/TechnicalSciences/$fileName';
