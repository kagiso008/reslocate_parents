...
class AgriculturalTechnologyGrade12Page extends StatefulWidget {
  const AgriculturalTechnologyGrade12Page({super.key});

  @override
  _AgriculturalTechnologyGrade12PageState createState() =>
      _AgriculturalTechnologyGrade12PageState();
}

class _AgriculturalTechnologyGrade12PageState
    extends State<AgriculturalTechnologyGrade12Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/AgriculturalTechnology');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/AgriculturalTechnology/$fileName';
