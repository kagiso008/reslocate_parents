...
class AgriculturalManagementPractices extends StatefulWidget {
  ...
  @override
  _AgriculturalManagementPracticesState createState() =>
      _AgriculturalManagementPracticesState();
}

class _AgriculturalManagementPracticesState
    extends State<AgriculturalManagementPractices> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_12/AgriculturalManagementPractices');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_12/AgriculturalManagementPractices/$fileName';
