...
class VisualArtsGrade11IEBPage extends StatefulWidget {
  const VisualArtsGrade11IEBPage({super.key});

  @override
  _VisualArtsGrade11IEBPageState createState() =>
      _VisualArtsGrade11IEBPageState();
}

class _VisualArtsGrade11IEBPageState extends State<VisualArtsGrade11IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_11/IEB/Visual Arts');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_11/IEB/Visual Arts/$fileName';
