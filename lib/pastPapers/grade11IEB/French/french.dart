...
class FrenchGrade11IEBPage extends StatefulWidget {
  const FrenchGrade11IEBPage({super.key});

  @override
  _FrenchGrade11IEBPageState createState() => _FrenchGrade11IEBPageState();
}

class _FrenchGrade11IEBPageState extends State<FrenchGrade11IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects =
          await supabase.storage.from('pdfs').list(path: 'grade_11/IEB/French');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_11/IEB/French/$fileName';
