...
class LifeSciencesGrade11IEBPage extends StatefulWidget {
  const LifeSciencesGrade11IEBPage({super.key});

  @override
  _LifeSciencesGrade11IEBPageState createState() =>
      _LifeSciencesGrade11IEBPageState();
}

class _LifeSciencesGrade11IEBPageState
    extends State<LifeSciencesGrade11IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_11/IEB/Life Sciences');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_11/IEB/Life Sciences/$fileName';
