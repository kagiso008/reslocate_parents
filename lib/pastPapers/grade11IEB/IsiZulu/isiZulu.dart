...
class IsiZuluGrade11IEBPage extends StatefulWidget {
  const IsiZuluGrade11IEBPage({super.key});

  @override
  _IsiZuluGrade11IEBPageState createState() => _IsiZuluGrade11IEBPageState();
}

class _IsiZuluGrade11IEBPageState extends State<IsiZuluGrade11IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_11/IEB/IsiZulu');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_11/IEB/IsiZulu/$fileName';
