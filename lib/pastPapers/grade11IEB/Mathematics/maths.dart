...
class MathsGrade11IEBPage extends StatefulWidget {
  const MathsGrade11IEBPage({super.key});

  @override
  _MathsGrade11IEBPageState createState() => _MathsGrade11IEBPageState();
}

class _MathsGrade11IEBPageState extends State<MathsGrade11IEBPage> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_11/IEB/Mathematics');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_11/IEB/Mathematics/$fileName';
