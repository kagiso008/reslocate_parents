...
class AccountingGrade10Page extends StatefulWidget {
  ...
  @override
  _AccountingGrade10PageState createState() => _AccountingGrade10PageState();
}

class _AccountingGrade10PageState extends State<AccountingGrade10Page> {
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_10/ACCOUNTING/$fileName';
