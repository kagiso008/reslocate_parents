...
class CollegeMatchesPage extends StatefulWidget {
  const CollegeMatchesPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CollegeMatchesPageState createState() => _CollegeMatchesPageState();
}

class _CollegeMatchesPageState extends State<CollegeMatchesPage> {
