...
class _StudentdetailsState extends State<Studentdetails> {
  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      // Check if the details match any existing row in the profiles table
      ...
      if (mounted) {
        try {
          ...
          if (studentResponse == null) {
            MyToast.showToast(context, 'No student found with this ID');
            return;
          }

          // Check if this is a student account
          if (studentResponse['is_parent'] == true) {
            MyToast.showToast(context, 'This ID belongs to a parent account');
            return;
          }
          ...
          await supabase.from('profiles').update({
            ...
            'parent_id': currentUserId, // Use the actual UUID
          }).eq('id', userId);
          ...
          if (error is FormatException) {
            MyToast.showToast(context, 'Invalid student ID format');
          } else {
            MyToast.showToast(
